...
function hideDesktopIconSwitch() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, isDesktopIconsHidden()];
                case 1:
                    stdOut = _a.sent();
                    isHidden = stdOut == 0;
...
here.on("load", function () { return __awaiter(_this, void 0, void 0, function () {
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                _a = here.popover;
                return [4, hideDesktopIconSwitch()];
            case 1:
                _a.data = [
                    _b.sent()
                ];
