...
function updateData() {
    ...
    http.get("https://here.app/release-notes.json")
        .then(function (response) {
            ...
            let tabs = [
                {
                    ...
                    data: [
                        ...
                        },
                        {
                            ...
                            onClick: () => {
                                here.openURL("https://here.app/release-notes");
                            },
                        },
                        {
                            title: "📦Plugin Store",
                            ...
                            onClick: () => {
                                here.openURL("https://github.com/hereappdev/Here-Plugins");
                            },
                        },
                        {
                            ...
                            onClick: () => {
                                here.openURL("https://t.me/HereApp");
                            },
                        },
                        {
                            title: "💬WeChat Group",
                            ...
                            onClick: () => {
                                here.openURL("https://res.here.app/img/wx.png");
                            },
                        },
                    ],
                },
            ...
            // Popover
            here.popover = new TabPopover(tabs);
            here.popover.reload();
        })
